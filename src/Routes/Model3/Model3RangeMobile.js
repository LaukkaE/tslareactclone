...
import background from '../../pics/model3/model3rangemobile.avif';
import { ModalContext } from '../../utils/ModalContext';

const Model3RangeMobile = () => {
    const setModal = useContext(ModalContext);

    return (
        <div className={`model3range horizontal_wrapper `}>
            <div
...
export default Model3RangeMobile;
