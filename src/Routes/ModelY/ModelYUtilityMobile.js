...
import background from '../../pics/modely/modelyutility.avif';
...
const ModelYUtilityMobile = () => {
    const setModal = useContext(ModalContext);

    return (
        <div className={`modelyutility horizontal_wrapper`}>
            <div
            ...
            <div className="utility_content horizontal_content">
                ...
                <div className="utility_content_right toggleable">
                    <p>
...
export default ModelYUtilityMobile;
